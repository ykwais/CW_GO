...
const (
	Greeting_Login_FullMethodName = "/com.example.grpc.Greeting/login"
)
...
func (c *greetingClient) Login(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, Greeting_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreetingServer) Login(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Greeting_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeting_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServer).Login(ctx, req.(*HelloRequest))
	}
...
var Greeting_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.example.grpc.Greeting",
	...
	Metadata: "api/proto/grpc_proto.proto",
}
